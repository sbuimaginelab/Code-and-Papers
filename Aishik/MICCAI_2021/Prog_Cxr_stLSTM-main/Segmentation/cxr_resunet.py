...
class UNet(nn.Module):
    def __init__(self, in_channels=1, n_classes=2, depth=5, wf=5, padding=True,
...
# net = UNet()
# print(list(net.state_dict().values())[:-2])
# name_list = []
# print(list(net.state_dict().keys()))
# print([name for name in list(net.state_dict().keys()) if name not in ['last.weight']])
# for name in net.state_dict().keys():
#     if name.split('.')[0] == 'last':
